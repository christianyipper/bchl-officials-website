              ...
              >
                <td className="pl-6 py-4 w-[348px] align-top">
                  ...
                  <div className="flex flex-nowrap items-start gap-1 mt-2 h-6">
                    {official.isActive && (
                      <span className="px-0 group-hover:px-2 h-2 w-2 group-hover:h-6 group-hover:w-auto rounded-full text-[10px] font-bold uppercase bg-orange-600 text-transparent group-hover:text-white transition-all duration-300 flex items-center overflow-hidden animate-pulse group-hover:animate-none">
                        <span className="w-0 group-hover:w-1 h-1 rounded-full bg-white group-hover:mr-1 animate-pulse group-hover:animate-none"></span>
                        Active
                      </span>
                    )}
