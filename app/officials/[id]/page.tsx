        ...
        <div className="bg-black rounded-lg shadow p-6 mb-8">
          ...
          <div className="mb-6 flex flex-row align-middle items-center gap-2">
            ...
            {official.isOriginal57 ? (
              <a href="https://bchl.ca/bchl-announces-officiating-staff-for-2023-24-season" target="_blank" className="px-3 py-1 rounded-full text-xs font-bold uppercase bg-[#9d5100] text-[#ffcf0e] border border-[#ffcf0e] shadow-glow-amber hover:scale-90 duration-300">
                OG : 57
              </a>
            ) : null}
